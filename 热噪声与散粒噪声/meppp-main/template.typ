...
#let meppp-lab-report(
  ...
  // title
  text(16pt, font: ("Times New Roman", "SimHei"))[
    #title\
  ]

  // author
  text(14pt, font: ("Times New Roman", "STKaiti"))[
    #author
  ]
  if author-footnote != [] {
    footnote(
  ...
  text(12pt,font: ("Times New Roman", "STKaiti"), info)
  ...
  if abstract != [] {
    pad(
      ...
      par(leading: 1.0em)[
        ...
        #h(2em)
        #abstract \ \
        #text(font: ("Times New Roman", "SimHei"))[关键词:]
        #let key = keywords.join([，])
        #text(10pt,font: ("Times New Roman", "SimSun"), key)
      ],
    )
  }
